...
namespace _0x5f_StoneSeries_Main_qml { 
...
Registry::Registry() {
    ...
    resourcePathToCachedUnit.insert(QStringLiteral("/StoneSeries/ShowDetails.qml"), &QmlCacheGeneratedCode::_0x5f_StoneSeries_ShowDetails_qml::unit);
...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appStoneSeries)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_appStoneSeries))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_appStoneSeries)() {
    return 1;
}
